...
pomodoro_btn = tk.Button(window, text = "Pomodoro", command = lambda: main(status, "pomodoro"))
countdown_btn = tk.Button(window, text = "Countdown", command = lambda: main(status, "countdown"))
stopwatch_btn = tk.Button(window, text = "Stopwatch", command = lambda: main(status, "stopwatch"))
